  ...
  return (
    ...
    >
      ...
      <TiltCard className="flex flex-col p-7">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-brand/15 to-heat/10 text-brand-lift transition-transform duration-300 group-hover:scale-110">
        ...
        <span className="mt-6 inline-flex items-center gap-1 text-sm font-semibold text-brand-lift">
          Learn more
